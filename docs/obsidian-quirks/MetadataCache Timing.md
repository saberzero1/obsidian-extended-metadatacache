...
[^tasks-cache]: [obsidian-tasks `Cache.ts:62-151` — `loadedAfterFirstResolve` pattern](https://github.com/obsidian-tasks-group/obsidian-tasks/blob/ba9f184d6704/src/Obsidian/Cache.ts#L62-L151)
[^dataview-index]: [obsidian-dataview `index.ts:188-202` — skips null caches](https://github.com/blacksmithgu/obsidian-dataview/blob/5ad0994ff384/src/data-index/index.ts#L188-L202)
